...
// modifications: changed filestream to memorystream; the audio .wav needs to be send to the backend instead of saving it locally
// this also made the filename argument redundant
// the save method now returns the created byte array as an out-parameter instead of saving it to disk
// renamed the save method to ConvertToWav in order to reflect its new purpose
...
public static class SavWav
{
    ...
    public static bool ConvertToWav(AudioClip clip, out byte[] wavBytes)
    {
