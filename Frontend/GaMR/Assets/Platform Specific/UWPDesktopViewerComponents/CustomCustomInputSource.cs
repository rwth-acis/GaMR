...
namespace HoloToolkit.Unity.InputModule
{
    ...
    /// </summary>
    [RequireComponent(typeof(CustomCustomInputControl))]
    public class CustomCustomInputSource : BaseInputSource
    {
        ...
        private CustomCustomInputControl manualController;
        ...
        private void Awake()
        {
            manualController = GetComponent<CustomCustomInputControl>();
