...
namespace HoloToolkit.Unity.InputModule
{
    ...
    /// </summary>
    public class CustomCustomInputControl : MonoBehaviour
    {
        ...
        public CustomAxisController PrimaryAxisTranslateControl;
        public CustomAxisController SecondaryAxisTranslateControl;
        ...
        private void Update()
        {
            ...
            if (PrimaryAxisRotateControl && SecondaryAxisRotateControl && TertiaryAxisRotateControl)
            {
                ...
                if ((PrimaryAxisRotateControl.axisType != CustomAxisController.AxisType.None && PrimaryAxisRotateControl.ShouldControl()) ||
                    (SecondaryAxisRotateControl.axisType != CustomAxisController.AxisType.None && SecondaryAxisRotateControl.ShouldControl()) ||
                    (TertiaryAxisRotateControl.axisType != CustomAxisController.AxisType.None && TertiaryAxisRotateControl.ShouldControl()))
                {
